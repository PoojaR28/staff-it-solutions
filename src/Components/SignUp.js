...
errors:{}
  ...
  render(){
    ...
    <div>{this.state.errors.userName}</div>
        ...
        <div class="form-group">
          <input type="text" placeholder="Enter phone Number" name="mobileNo" value={this.state.fields.mobileNo} onChange={this.handleChange} />
          <div>{this.state.errors.mobileNo}</div>
</div>
        <div class="form-group">
          <input type="email" placeholder="Enter Email Address" name="emailId" value={this.state.fields.emailId} onChange={this.handleChange}/>
...
<div class="form-group">
        ...
        <Link to={`/Card/${this.state.fields.status}/${this.state.fields.userName}/${this.state.fields.mobileNo}/${this.state.fields.emailId}/${this.state.fields.exp}/${this.state.fields.date}/${this.state.fields.facebook}/${this.state.fields.linkedin}/${this.state.fields.instagram}}`}>
